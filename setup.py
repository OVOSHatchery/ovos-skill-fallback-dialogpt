...
PYPI_NAME = "skill-ovos-fallback-dialogpt"  # pip install PYPI_NAME
URL = f"https://github.com/OpenVoiceOS/{PYPI_NAME}"
SKILL_CLAZZ = "DialoGPTSkill"  # needs to match __init__.py class name
...
setup(
    name=PYPI_NAME,
    version=get_version(),
    description='ovos DialoGPT skill',
